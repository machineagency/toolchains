import{y as l}from"./index-c839d3ed.js";const t={inports:{},outports:{num:{type:"number",value:1}},state:{value:1,min:0,max:1e3,step:1},ui:{displayName:"Slider",width:"175px",height:"45px"}};function o(p,r,e){function i(n){e.value=Number(n),r.num.value=e.value}function a(){return l`<style>
        #container {
          height: 100%;
          display: flex;
