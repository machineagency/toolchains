import{y}from"./lit-html-b7b68613.js";import{n as g,e as k}from"./ref-07f75f10.js";import{S as w,h as v,j as S,E as a,k as x,l,e as E,g as $,m as P,n as C}from"./editor-7887b23b.js";import{j as F}from"./index-8347ce50.js";import"./main-1ec7c7df.js";const s=w.define(),c=v.define({create:()=>!1,update(t,e){for(let n of e.effects)n.is(s)&&(t=n.value);return t},provide:t=>S.from(t,e=>e?T:null)});function T(t){let e=document.createElement("div");return e.textContent="F1: Toggle the help panel",e.className="cm-help-panel",{top:!0,dom:e}}const I=[{key:"F1",run(t){return t.dispatch({effects:s.of(!t.state.field(c))}),!0}}],R=a.baseTheme({".cm-help-panel":{padding:"5px 10px",color:"var(--black)",backgroundColor:"#fffa8f",fontFamily:"monospace"}});function j(){return[c,x.of(I),R]}const A=[l("function ${name}(${params}) {\n	${}\n}",{label:"function",detail:"definition",type:"keyword"}),l(`function setup() {
	\${}
}
